...
class TestFlaskRoutes(unittest.TestCase):
    ...
    def test_search_include_omit_route(self, mock_connect):
        ...
        mock_connect.return_value = self.mock_conn
        self.mock_cursor.fetchall.return_value = [(11329, 'Broccoli-Mascarpone Soup', 'Heat oil in large pot over medium heat. Add shallots; sauté 3 minutes. Add broccoli; sauté 1 minute. Add broth; bring to boil. Reduce heat to medium-low. Cover and simmer until vegetables are tender, about 10 minutes. Cool slightly.\nWorking in batches, transfer soup to blender; puree until smooth. Return to pot. Reserve 1/4 cup mascarpone in small bowl; cover and chill. Whisk 1 1/4 cups mascarpone and cayenne pepper into soup. Season with salt. DO AHEAD Can be made 1 day ahead. Cover; chill. Heat soup over medium heat, stirring occasionally; do not boil.\nLadle soup into bowls. Garnish with reserved mascarpone. Sprinkle with chopped chives and serve.', "['3 tablespoons olive oil', '1 1/2 cups sliced shallots (about 6 large)', '1 1/2 pounds broccoli florets, cut into 1-inch pieces', '6 cups low-salt chicken broth', '1 1/2 cups (12 ounces) mascarpone cheese (Italian cream cheese), divided', '1/4 teaspoon cayenne pepper', '3 tablespoons chopped fresh chives']"), (11538, 'Mac and Cheese with Chicken and Broccoli', 'Prepare barbecue (medium heat). Sprinkle chicken with salt and pepper. Brush both sides with olive oil. Grill until cooked through, about 6 minutes per side. Dice chicken and set aside. Cook broccoli in medium pot of boiling salted water until crisp-tender, about 3 minutes. Set aside.\nMelt butter in heavy large saucepan over medium heat. Add flour and cook 2 minutes, stirring constantly. Gradually mix in cream. Bring to boil, reduce heat, and simmer 10 minutes, stirring frequently. Add both cheeses and stir until sauce is smooth. Season to taste with salt and pepper. Add pasta, chicken, and broccoli to sauce; mix well. Garnish with chives and serve.', "['1 pound skinless boneless chicken breasts', 'Olive oil (for brushing)', '2 heads of broccoli, cut into florets (about 5 cups)', '2 tablespoons (1/4 stick) unsalted butter', '2 tablespoons all purpose flour', '4 cups whipping cream', '1 cup grated Fontina cheese (about 4 ounces)', '1 cup grated cheddar cheese (about 4 ounces)', '1 pound pasta shells, freshly cooked', '1/2 bunch fresh chives', 'chopped']"), (12574, 'Cauliflower and Broccoli Flan with Spinach Bechamel', 'Cook cauliflower and broccoli in large pot of boiling salted water until crisp-tender, about 5 minutes. Drain, reserving 2/3 cup cooking liquid. Transfer vegetables to large bowl. Cool.\nRinse spinach, then toss in large nonstick skillet over medium-high heat until just wilted. Drain and cool. Squeeze spinach dry; finely chop.\nMelt butter in heavy medium saucepan over medium heat. Add flour and whisk until smooth, about 2 minutes. Gradually whisk in milk and reserved 2/3 cup vegetable cooking liquid. Whisk constantly over medium heat until sauce thickens and boils, about 3 minutes. Stir in spinach and cheese.\nUsing fingers, coarsely crumble cauliflower and broccoli in bowl. Add spinach béchamel sauce; stir to blend. Season with salt and pepper. Butter 1 1/2-quart baking dish. Spread vegetable mixture in prepared dish. (Can be made 6 hours ahead. Cover and chill.)\nPreheat oven to 350°F. Bake flan until puffed and heated through, about 25 minutes if at room temperature and 35 minutes if chilled. Serve hot.', "['2 1/2 cups cauliflower florets', '2 1/2 cups broccoli florets', '2 6-ounce bags baby spinach leaves', '6 tablespoons (3/4 stick) butter', '1/4 cup all purpose flour', '2/3 cup whole milk', '2/3 cup freshly grated Parmesan cheese']")]
